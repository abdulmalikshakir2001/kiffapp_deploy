...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container-fluid p-4 create_user_main">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="" method="post" id="users_permissions_form">
                        @csrf
                  ...
                  Users Permissions added 
                    <i class="fa-solid fa-xmark  fa_xmark_user float-end fs-4"></i>
                                ...
                                <div class="text-center">
                                    <button type="submit" id="added_users_permissions_btn" class="btn bg-gradient-dark w-100 my-4 mb-2">Add Permissions</button>
                                </div>
                            </div>
                        </div>
                    </form>
