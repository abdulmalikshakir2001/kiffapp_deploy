...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container-fluid p-4 create_user_main">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="" method="post" id="update_to_do_tasks_form">
                        <input type="hidden" name="to_do_task_id" id="to_do_task_id" 
                        @if($single_to_do_tasks)  value="{{$single_to_do_tasks->to_do_task_id}}" @endif>
                        @csrf
                  ...
                  <div class="alert alert-success  d-none text-white user_updated_msg" role="alert">
                    ...
                    <i class="fa-solid fa-xmark  fa_xmark_user float-end fs-4"></i>
                                ...
                                <div class="mb-3 ">
                                    ...
                                    @if($single_to_do_tasks)  value="{{$single_to_do_tasks->task_name}}" @endif
                                    >
                                </div>
                                <!-- task description start  -->
                                <div class="mb-3 ">
                                    <textarea name="task_description" id="task_description" cols="" rows="" class="form-control" placeholder="Enter Description for task here ...">
                                    @if($single_to_do_tasks)  {{$single_to_do_tasks->task_description}} @endif
                                    </textarea>
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    <div class="form-check form-switch">
                                        ...
                                        @if($single_to_do_tasks) {{$single_to_do_tasks->status=='1'?'checked':''}} @endif
                                        >
                                        <label class="form-check-label" for="is_paid_offline">Status</label>
                                    </div>
                                </div>
                                <!-- task  name  end -->
                                
                                <div class="text-center">
                                    <button type="submit" id="update_to_do_tasks_btn" class="btn bg-gradient-dark w-100 my-4 mb-2">Update Task</button>
                                </div>
