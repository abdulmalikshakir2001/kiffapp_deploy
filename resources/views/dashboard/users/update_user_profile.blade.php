...
<div class="row">
    <div class="col-md-12 p-0 col-wrapper">
        ...
        <div class="container-fluid p-4 create_user_main">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="" method="" id="user_profile_udpate_form">
                        @csrf
                        <input type="hidden" name="remember_token" id="remember_token">
                        <div class="container-fluid">
                            <div class="row">
                                <!-- show message when updaate user start  -->
                                ...
                                <!-- show message when updaate user end  -->
                                <!-- accordian starts  -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-md-3 mt-3">
                                                            ...
                                                            <select name="ui_language" id="ui_language" class="form-select ui_lang">
                                                                <option></option>
                                                                <option value="en"
                                                                {{$user->ui_language=="en"?"selected":""}}
                                                                >English</option>
                                                                <option value="ar"
                                                                {{$user->ui_language=="ar"?"selected":""}}
                                                                >Arabic</option>
                                                            </select>
                                                        </div>
                                ...
                                <div class="text-center">
                                    <button type="submit" id="updated_profile_btn" class="btn bg-gradient-dark w-100 my-4 mb-2">Update Profile</button>
                                </div>
                                <!-- <p class="text-sm mt-3 mb-0">Already have an account? < href="{{route('login')}}" class="text-dark font-weight-bolder">Sign in</
                a></p> -->
                            </div>
                        </div>
                    </form>
