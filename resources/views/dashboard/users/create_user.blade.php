          ...
          <div class="col-md-8">
            <div class="parent">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-6 form-check">
                  <input class="form-check-input" type="checkbox" id="allow_login" name="allow_login" checked>
            ...
            <div class="parent">
              <div class="row justify-content-end">
                <div class="col-md-2">
                  ...
                  <button type="submit" class="btn btn-primary  w-100" id="added_user_btn">Add User</button>
