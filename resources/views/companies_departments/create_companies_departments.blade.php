...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container-fluid p-4 create_user_main">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="" method="post" id="companies_departments_form">
                        @csrf
                  ...
                  <div class="alert alert-success  d-none text-white user_updated_msg" role="alert">
                    ...
                    <i class="fa-solid fa-xmark  fa_xmark_user float-end fs-4"></i>
                                ...
                                <div class="mb-3 col-md-6">
                                    <input type="text" class="form-control" placeholder="Department Name" aria-label="Department Name" name="department_name" id="department_name">
                                </div>

                                <div class="text-center">
                                    <button type="submit" id="added_com_dep_btn" class="btn bg-gradient-dark w-100 my-4 mb-2">Add Department</button>
                                </div>
                            </div>
                        </div>
                    </form>
