...
@section('body_content')
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="" id="subscription_packages_updated_form">
                <input type="hidden" name="package_id" id="package_id" value="{{ $single_subscription_packages->package_id }}">
                @csrf
                    ...
                    <div class="row gy-4 profile_row">
                        ...
                        <div class="col-md-12">
                            <div class="parent">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h5 class="">Update Subscription Package</h5>
                                    </div>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Package Name"
                                            ...
                                            value="{{ $single_subscription_packages->package_name }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Package Description"
                                            ...
                                            value="{{ $single_subscription_packages->package_description }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Price" aria-label="Price"
                                            name="price" id="price"
                                            value="{{ $single_subscription_packages->price }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" placeholder="duration"
                                            ...
                                            value="{{ $single_subscription_packages->duration }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" placeholder="Trail period in days"
                                            ...
                                            value="{{ $single_subscription_packages->trail_period_in_days }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Sort Order"
                                            ...
                                            value="{{ $single_subscription_packages->sort_order }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="{{ $single_subscription_packages->allowed_users }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="{{ $single_subscription_packages->allowed_products }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="{{ $single_subscription_packages->allowed_customers }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="{{ $single_subscription_packages->allowed_suppliers }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="{{ $single_subscription_packages->allowed_purchaseorders }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="{{ $single_subscription_packages->allowed_salesinvoices }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="{{ $single_subscription_packages->allowed_accounts }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="duration_type" id="duration_type"
                                            ...
                                            <option></option>
                                            <option
                                                value="Days"{{ $single_subscription_packages->duration_type == 'Days' ? 'selected' : '' }}>
                                                Days</option>
                                            <option value="Months"
                                                {{ $single_subscription_packages->duration_type == 'Months' ? 'selected' : '' }}>
                                                Months</option>
                                            <option value="Years"
                                                {{ $single_subscription_packages->duration_type == 'Years' ? 'selected' : '' }}>
                                                Years</option>
                                        </select>
                                    </div>
                            ...
                            <div class="parent">
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-3 form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="module_hrm"
                                            name="module_hrm"
                                            {{ $single_subscription_packages->module_hrm == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3 form-check form-switch">
                                        <input class="form-check-input " type="checkbox" id="module_crm"
                                            name="module_crm"
                                            {{ $single_subscription_packages->module_crm == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3 form-check form-switch">
                                        <input class="form-check-input " type="checkbox" id="module_products"
                                            ...
                                            {{ $single_subscription_packages->module_products == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3 form-check form-switch">
                                        <input class="form-check-input " type="checkbox" id="module_purchase"
                                            ...
                                            {{ $single_subscription_packages->module_purchase == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3 form-check form-switch">
                                        <input class="form-check-input " type="checkbox" id="module_inventroy"
                                            ...
                                            {{ $single_subscription_packages->module_inventroy == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3 form-check form-switch">
                                        <input class="form-check-input " type="checkbox" id="module_sales"
                                            name="module_sales"
                                            {{ $single_subscription_packages->module_sales == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-3 form-check form-switch">
                                        ...
                                        <input class="form-check-input " type="checkbox" id="module_accounts"
                                            ...
                                            {{ $single_subscription_packages->module_accounts == '1' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12 form-check ">
                                    <input class="form-check-input " type="checkbox" id="is_active" name="is_active"
                                        {{ $single_subscription_packages->is_active == '1' ? 'checked' : '' }}>
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-md-2">
                                        ...
                                        <button type="submit" class="btn btn-primary  w-100"
                                            id="udpated_subscription_package_btn">Update
                                        </button>
