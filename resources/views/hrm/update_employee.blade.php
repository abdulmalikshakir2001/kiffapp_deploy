                        ...
                        <div class="parent">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Employee no" aria-label="Employee no" name="employee_no" id="employee_no" value="{{$single_user->employee_no}}">
                                </div>

                                <div class="col-md-4">
                                    <label for="">Basic Salary</label>
                                    <input type="text" class="form-control" placeholder="Basic Salary" aria-label="Basic Salary" name="basic_salary" id="basic_salary" value="{{$single_user->basic_salary}}">
                                </div>

                                <div class="col-md-4">
                                    <label for="food_allownce">Food Allownce</label>
                                    <input type="text" class="form-control" placeholder="Food Allownce" aria-label="Food Allownce" name="food_allownce" id="food_allownce" value="{{$single_user->food_allownce}}">
                                </div>

                                <div class="col-md-4">
                                    <label for="medical_allownce">Medical Allownce</label>
                                    <input type="text" class="form-control" placeholder="Medical Allownce" aria-label="Medical Allownce" name="medical_allownce" id="medical_allownce"  value="{{$single_user->medical_allownce}}">

                                </div>
                                <div class="col-md-4">
                                    <label for="transport_allownce">Transport Allownce</label>
                                    <input type="text" class="form-control" placeholder="Transport Allownce" aria-label="Transport Allownce" name="transport_allownce" id="transport_allownce" value="{{$single_user->transport_allownce}}">
                                </div>

                                <div class="col-md-4">
                                    <label for="other_allownces">Other Allownce</label>
                                    <input type="text" class="form-control" placeholder="Other Allownce" aria-label="Other Allownce" name="other_allownces" id="other_allownces" value="{{$single_user->other_allownces}}">
                                </div>
                                <div class="col-md-4">
                                    <label for="">Work Shift</label>
                                    <select name="work_shift_id" id="work_shift_id" class="form-select">
                                        <option></option>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <option value="{{$warehouse->warehouse_id}}"
                                                {{$single_user->warehouse_id==$warehouse->warehouse_id?"selected":""}}
                        ...
                        <div class="parent">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Credit limit" aria-label="Credit limit" name="credit_limit" id="credit_limit" value="{{$single_user->credit_limit}}">
                                </div>

                                <div class="col-md-4">
                                    <label for="">Bank Details</label>
                                    <textarea name="bank_details" id="bank_details" cols="" rows="1" placeholder="Bank Details" class="form-control">{{$single_user->bank_details}}</textarea>
                                </div>

                                <div class="col-md-4">
                                    <label for="">Tax Number</label>
                                    <input type="text" class="form-control" placeholder="Tax number" aria-label="Tax number" name="tax_number" id="tax_number" value="{{$single_user->tax_number}}">
                                </div>
                        ...
                        <div class="parent">
                            <div class="row justify-content-end">
                                <div class="col-md-2">
                                    ...
                                    <button type="submit" class="btn btn-primary  w-100" id="added_user_btn">Update Employee</button>
