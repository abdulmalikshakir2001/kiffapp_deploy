...
<head>
    ...
    <link rel="stylesheet" href="{{public_path('dashboard_assets/create_update_user/css/create_user.css')}}">
<link rel="stylesheet" href="{{public_path('dashboard_assets/hrm/css/hrm_employee_details_print.css')}}">
...
<div class="user_info_photo">
                    ...
                    <div class="col-12 employee_information_main" >
                        <div class="parent">
                            <h5 class="">Employee Information</h5>
                            <div class="row gy-3 employee_information_inputs">
                                ...
                                <div class="col-4">
                                    ...
                                    <select disabled name="work_shift_id" id="work_shift_id" class="form-select" style="border: 2px solid #d2d6da;font-family:'Roboto', sans-serif;color:black;">
                                        <option></option>
                    ...
                    <!-- bank details start  -->
                    <div class="col-12 bank_details_main">
                        <div class="parent">
                            <h5 class="">Bank Details</h5>
                            <div class="row gy-3 bank_details_inputs">
                                ...
                                <div class="col-4">
                                    ...
                                    <textarea disabled name="bank_details" id="bank_details" cols="" rows="1" placeholder="Bank Details" class="form-control input_diabled" style="border: 2px solid #d2d6da; font-family:'Roboto', sans-serif;color:black;">{{$single_user->bank_details}}</textarea>
                                </div>
