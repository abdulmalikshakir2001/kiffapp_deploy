            ...
            <div class="parent">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" placeholder="Employee no" aria-label="Employee no" name="employee_no" id="employee_no">
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" placeholder="Food Allownce" aria-label="Food Allownce" name="food_allownce" id="food_allownce">
                </div>

                <div class="col-md-4">
                  <label for="medical_allownce">Medical Allownce</label>
                  <input type="text" class="form-control" placeholder="Medical Allownce" aria-label="Medical Allownce" name="medical_allownce" id="medical_allownce">

                </div>
                <div class="col-md-4">
                  <label for="transport_allownce">Transport Allownce</label>
                  <input type="text" class="form-control" placeholder="Transport Allownce" aria-label="Transport Allownce" name="transport_allownce" id="transport_allownce">
                </div>

                <div class="col-md-4">
                  <label for="other_allownces">Other Allownce</label>
                  <input type="text" class="form-control" placeholder="Other Allownce" aria-label="Other Allownce" name="other_allownces" id="other_allownces">
                </div>
                <div class="col-md-4">
                  ...
                  <select name="work_shift_id" id="work_shift_id" class="form-select">
                    ...
                    <option value="{{$work_shift->work_shift_id}}">{{$work_shift->shift_name}}</option>
                    @endforeach
                  </select>
                </div>
            ...
            <div class="parent">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" placeholder="Credit limit" aria-label="Credit limit" name="credit_limit" id="credit_limit">
                </div>

                <div class="col-md-4">
                  <label for="">Bank Details</label>
                  <textarea name="bank_details" id="bank_details" cols="" rows="1" placeholder="Bank Details" class="form-control"></textarea>
                </div>

                <div class="col-md-4">
                  <label for="">Tax Number</label>
                  <input type="text" class="form-control" placeholder="Tax number" aria-label="Tax number" name="tax_number" id="tax_number">
                </div>
            ...
            <div class="parent">
              <div class="row justify-content-end">
                <div class="col-md-2">
                  ...
                  <button type="submit" class="btn btn-primary  w-100" id="added_user_btn">Add Employee</button>
    ...
    $("#user_added_form").validate({
      rules: {
        ...
        employee_no:{
          required:true,
          remote: {
            url: base_url + "is_exist_employee_no",
            type: "post",
            data: {
              email: function() {
      ...
      messages: {
        ...
        other_allownces: {
          required: "Other allownce Required",
        },
        transport_allownce: {
          required: "Transport allownce Required",
        },
        medical_allownce: {
          required: "Medical allownce Required",
        },
        food_allownce: {
          required: "Food Allownce Required",
        },
        last_name: {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (response == 1) {
              ...
              defaultSelect2($('#work_shift_id'))
              defaultSelect2($('#warehouse_id'))
              defaultSelect2($('#ui_language'))
              defaultSelect2($('#blood_group'))
              defaultSelect2($('#marital_status'))
