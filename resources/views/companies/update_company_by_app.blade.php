...
@section('page_header_links')
    <link rel="stylesheet" href="{{ asset('dashboard_assets/companies/css/update_companies.css') }}">
@endSection
@section('body_content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="" id="companies_updated_form">
                <input type="hidden" name="company_id" id="company_id" value="{{ $single_companies->company_id }}">
                @csrf
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Company Name"
                                            ...
                                            value="{{ $single_companies->company_name }}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Registration Number"
                                            ...
                                            id="registration_number" value="{{ $single_companies->registration_number }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Phone Number"
                                            ...
                                            value="{{ $single_companies->phone_number }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Contact Number"
                                            ...
                                            value="{{ $single_companies->contact_number }}">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="email" class="form-control" placeholder="Email" aria-label="Email"
                                            name="email" id="email" value="{{ $single_companies->email }}">
                                    ...
                                    <div class="col-md-12 form-check">
                                        <input type="checkbox" name="is_active" id="is_active" class="form-check-input"
                                            {{ $single_companies->is_active == '1' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="parent h-100">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-12">
                                        {{-- <img src="{{asset('app/public/company_logo/'.$single_user->profile_logo)}}" alt="" width="100%" height="200px" style="border-radius:10px;"> --}}

                                            @if($single_companies->logo)
                                            <img src="{{asset('app/public/company_logo/'.$single_companies->logo)}}" alt="" width="100%" height="200px" style="border-radius:10px;">
                                            @else
                            ...
                            <div class="parent">
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea name="address" id="address" cols="" rows="1" class="form-control" placeholder="Address">{{ $single_companies->address }}</textarea>
                                    </div>

                                    <div class="col-md-4">
                                        <label for="">City</label>
                                        <input type="text" class="form-control" placeholder="City" aria-label="City"
                                            name="city" id="city" value="{{ $single_companies->city }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="landmark"
                                            ...
                                            value="{{ $single_companies->landmark }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Zip Code"
                                            ...
                                            value="{{ $single_companies->zip_code }}">
                                    </div>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea cols="" rows="1" class="form-control" name="pos_settings" id="pos_settings"
                                            placeholder="Pos Settings">{{ $single_companies->pos_settings }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea cols="" rows="1" class="form-control" name="email_settings" id="email_settings"
                                            placeholder="Email Settings">{{ $single_companies->email_settings }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea cols="" rows="1" class="form-control" name="sms_settings" id="sms_settings"
                                            placeholder="Sms Settings">{{ $single_companies->sms_settings }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea cols="" rows="1" class="form-control" name="common_settings" id="common_settings"
                                            placeholder="Common Settings">{{ $single_companies->common_settings }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="website"
                                            ...
                                            value="{{ $single_companies->website }}">
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="currency_symbol_placement" id="currency_symbol_placement"
                                            ...
                                            <option></option>
                                            <option value="before"
                                                {{ $single_companies->currency_symbol_placement == 'before' ? 'selected' : '' }}>
                                                Before</option>
                                            <option value="after"
                                                {{ $single_companies->currency_symbol_placement == 'after' ? 'selected' : '' }}>
                                                After</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="stock_accounting_method" id="stock_accounting_method"
                                            ...
                                            <option></option>
                                            <option value="fifo"
                                                {{ $single_companies->stock_accounting_method == 'fifo' ? 'selected' : '' }}>
                                                FIFO</option>
                                            <option value="lifo"
                                                {{ $single_companies->stock_accounting_method == 'lifo' ? 'selected' : '' }}>
                                                LIFO</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="enable_purchase" id="enable_purchase"
                                            ...
                                            <option></option>
                                            <option value="1"
                                                {{ $single_companies->enable_purchase == '1' ? 'selected' : '' }}>Enable
                                            </option>
                                            <option value="0"
                                                {{ $single_companies->enable_purchase == '0' ? 'selected' : '' }}>Disable
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="enable_product_expiry" id="enable_product_expiry"
                                            ...
                                            <option></option>
                                            <option value="1"
                                                {{ $single_companies->enable_product_expiry == '1' ? 'selected' : '' }}>
                                                Enable
                                            </option>
                                            <option value="0"
                                                {{ $single_companies->enable_product_expiry == '0' ? 'selected' : '' }}>
                                                Disable
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="enable_price_tax" id="enable_price_tax"
                                            ...
                                            <option></option>
                                            <option value="1"
                                                {{ $single_companies->enable_price_tax == '1' ? 'selected' : '' }}>Enable
                                            </option>
                                            <option value="0"
                                                {{ $single_companies->enable_price_tax == '0' ? 'selected' : '' }}>Disable
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="enable_category" id="enable_category"
                                            ...
                                            <option></option>
                                            <option value="1"
                                                {{ $single_companies->enable_category == '1' ? 'selected' : '' }}>Enable
                                            </option>
                                            <option value="0"
                                                {{ $single_companies->enable_category == '0' ? 'selected' : '' }}>Disable
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="enable_sub_category" id="enable_sub_category"
                                            ...
                                            <option></option>
                                            <option value="1"
                                                {{ $single_companies->enable_sub_category == '1' ? 'selected' : '' }}>
                                                Enable
                                            </option>
                                            <option value="0"
                                                {{ $single_companies->enable_sub_category == '0' ? 'selected' : '' }}>
                                                Disable
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="enable_brand" id="enable_brand" class="form-select enable_brand">
                                            <option></option>
                                            <option value="1"
                                                {{ $single_companies->enable_brand == '1' ? 'selected' : '' }}>Enable
                                            </option>
                                            <option value="0"
                                                {{ $single_companies->enable_brand == '0' ? 'selected' : '' }}>Disable
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="time_format" id="time_format" class="form-select time_format">
                                            ...
                                            <option></option>
                                            <option value="12"
                                                {{ $single_companies->time_format == '12' ? 'selected' : '' }}>12</option>
                                            <option value="24"
                                                {{ $single_companies->time_format == '24' ? 'selected' : '' }}>24</option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="default_barcode_type" id="default_barcode_type"
                                            ...
                                            <option></option>
                                            <option value="C128"
                                                {{ $single_companies->default_barcode_type == 'C128' ? 'selected' : '' }}>
                                                C128
                                            </option>
                                            <option value="C39"
                                                {{ $single_companies->default_barcode_type == 'C39' ? 'selected' : '' }}>
                                                C39
                                            </option>
                                            <option value="EAN13"
                                                {{ $single_companies->default_barcode_type == 'EAN13' ? 'selected' : '' }}>
                                                EAN13
                                            </option>
                                            <option value="EAN8"
                                                {{ $single_companies->default_barcode_type == 'EAN8' ? 'selected' : '' }}>
                                                EAN8
                                            </option>
                                            <option value="UPCA"
                                                {{ $single_companies->default_barcode_type == 'UPCA' ? 'selected' : '' }}>
                                                UPCA
                                            </option>
                                            <option value="UPCE"
                                                {{ $single_companies->time_format == 'UPCE' ? 'selected' : '' }}>UPCE
                                            </option>
                                        </select>
                                        ...
                                        <select name="country_id" id="country_id" class="form-select country_id">
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->country_id }}"
                                                    {{ $single_companies->country_id == $country->country_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                      <label for="">Default Sales Discount</label>
                                      <input type="text" class="form-control"
                                          ...
                                          value="{{ $single_companies->default_sales_discount_percent }}">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="Default Profit Percent"
                                        ...
                                        value="{{ $single_companies->default_profit_percent }}">
                                </div>
                                  ...
                                  <div class="col-md-4">
                                      ...
                                      <input type="text" class="form-control"
                                          ...
                                          value="{{ $single_companies->default_sales_tax_percent }}">
                                  </div>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tax1 Name"
                                            ...
                                            value="{{ $single_companies->tax1_name }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tax2 Name"
                                            ...
                                            value="{{ $single_companies->tax2_name }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tax1 Number"
                                            ...
                                            value="{{ $single_companies->tax1_number }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tax2 Number"
                                            ...
                                            value="{{ $single_companies->tax2_number }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Sku Prefix"
                                            ...
                                            value="{{ $single_companies->sku_prefix }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="time_zone"
                                            ...
                                            value="{{ $single_companies->time_zone }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Date format"
                                            ...
                                            value="{{ $single_companies->date_format }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="fy Start Month"
                                            ...
                                            value="{{ $single_companies->fy_start_month }}">
                            ...
                            <div class="parent">
                                <div class="row justify-content-end">
                                    <div class="col-md-2">
                                        ...
                                        <button type="submit" class="btn btn-primary  w-100" id="update_companies_btn">Update
                                            Company</button>
        ...
        $(document).ready(function() {
            ...
            $("#companies_updated_form").validate({
                ...
                submitHandler: function(form) {
                    $.ajax({
                        type: "post",
                        url: base_url + "updateCompaniesPost",
