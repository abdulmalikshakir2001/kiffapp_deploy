        ...
        <div class="row gy-4 profile_row">
          ...
          <div class="col-md-12">
            <div class="parent">
              <div class="row">
                <div class="col-md-4">
                  <h5 class="">Update Lead</h5>
                </div>

                <div class="col-md-8">
                  <div class="alert alert-success  d-none text-white crmLeadUpdateMessage user_updated_msg" role="alert" id="crmLeadaddedMessage">
            ...
            <div class="parent">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="subject" id="subject" cols="" rows="1" placeholder="Subject" class="form-control">{{$lead->subject}}</textarea>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" name="creation_date" id="creation_date" class="form-control" value="{{$lead->creation_date}}">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="parent h-100">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" placeholder="Lead reffered By" aria-label="Lead reffered By" name="lead_reffered_by" id="lead_reffered_by" value="{{$lead->lead_reffered_by}}">
            ...
            <div class="parent">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" placeholder="Remarks" aria-label="Zip code" name="remarks" id="remarks" value="{{$lead->remarks}}">
                </div>

                <div class="col-md-4">
                  <label for="internal_notes">Internal Notes</label>
                  <textarea name="internal_notes" id="" cols="" rows="1" id="internal_notes" placeholder="Internal Notes" class="form-control">{{$lead->internal_notes}}</textarea>
                </div>


                <div class="col-md-4">
                  <label for="external_info">External Information</label>
                  <textarea name="external_info" id="" cols="" rows="1" id="external_info" placeholder="External Information" class="form-control">{{$lead->external_info}}</textarea>
                </div>
            ...
            <div class="parent">
              <div class="row justify-content-end">
                <div class="col-md-2">
                  ...
                  <button type="submit" class="btn btn-primary  w-100" id="added_user_btn">Update Lead</button>
...
// employee id
    ...
    $("#crmLeadUpdateForm").validate({
      ...
      submitHandler: function(form) {
        $.ajax({
          type: "post",
          url: base_url + "leadUpdate",
          data: new FormData(form),
          processData: false,
          contentType: false,
          success: function(response) {
            if (response == 'true') {
              $("#crmLeadUpdateForm").trigger("reset");
              $(".crmLeadUpdateMessage").removeClass("d-none");
              window.scrollTo(0, 0)
            }
          },
        });
