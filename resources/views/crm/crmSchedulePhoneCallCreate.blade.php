...
@section('body_content')
    <div class="row">
        <div class="col-md-12">
            <form action="" id="crmSchedulePhoneCallAddedForm">
                @csrf
                    ...
                    <div class="row gy-4 profile_row">
                        ...
                        <div class="col-md-12">
                            <div class="parent">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h5 class="">Add Schedule Phone Call</h5>
                                    </div>

                                    <div class="col-md-8">
                                        <div class="alert alert-success  d-none text-white crmSchedulePhoneCallAddedMessage user_updated_msg"
                                            role="alert" id="crmSchedulePhoneCalladdedMessage">
                                            Schedule Phone Call added successfully
                                ...
                                <div class="row gy-3">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Duration"
                                            aria-label="Schedule Phone Call reffered By" name="duration"
                                            id="duration">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Responsible"
                                            aria-label="Expected Revenue" name="responsible" id="responsible">
                                    </div>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Remarks"
                                            aria-label="Schedule Phone Call reffered By" name="remarks"
                                            id="remarks">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="call_summary">Call Summary</label>
                                        <textarea name="call_summary" id="" cols="" rows="1" id="call_summary"
                                            placeholder="Call Summary" class="form-control"></textarea>
                                    </div>
...
@section('page_script_links')
    <script>
        $(document).ready(function() {
            ...
            //
            // crm lead add  start
            $("#crmSchedulePhoneCallAddedForm").validate({
                rules: {
                    contact_id: {
                        required: true,
                    },
                ...
                submitHandler: function(form) {
                    $.ajax({
                        type: "post",
                        url: base_url + "schedulePhoneCall",
                        ...
                        success: function(response) {
                            if (response == 'true') {
                                ...
                                defaultSelect2($('#oppertunity_id'))

                                $("#crmSchedulePhoneCallAddedForm").trigger("reset");
                                $(".crmSchedulePhoneCallAddedMessage").removeClass(
                                    "d-none");
                                window.scrollTo(0, 0)
                            }
                        },
