...
@section('body_content')
    <div class="row">
        <div class="col-md-12">
            <form action="" id="crmOppertunityAddedForm">
                @csrf
                    ...
                    <div class="row gy-4 profile_row">
                        ...
                        <div class="col-md-12">
                            <div class="parent">
                                <div class="row">
                                    <div class="col-md-4">
                                        <h5 class="">Add Oppertunity</h5>
                                    </div>

                                    <div class="col-md-8">
                                        <div class="alert alert-success  d-none text-white crmOppertunityAddedMessage user_updated_msg"
                                            role="alert" id="crmOppertunityaddedMessage">
                                            Oppertunity added successfully
                            ...
                            <div class="parent h-100">
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Expected Revenue"
                                            aria-label="Expected Revenue" name="expected_revenue" id="expected_revenue">
                                    </div>
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <textarea name="next_action_remarks" id="" cols="" rows="1" id="next_action_remarks"
                                            placeholder="Next Action remarks" class="form-control"></textarea>
                                    </div>
                                    <div class="col-md-4">
...
@section('page_script_links')
    <script>
        $(document).ready(function() {
            ...
            //
            // crm lead add  start
            $("#crmOppertunityAddedForm").validate({
                rules: {
                    contact_id: {
                        required: true,
                    },
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response == 'true') {
                                ...
                                $("#crmOppertunityAddedForm").trigger("reset");
                                $(".crmOppertunityAddedMessage").removeClass("d-none");
                                window.scrollTo(0, 0)
                            }
                        },
                    });
