...
<div class="row">
  <div class="col-md-12 ">
    ...
    <div class="modal fade" id="status_change_modal" tabindex="-1" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
              id="status_change_close">Close</button>
            <button type="button" class="btn btn-primary" id="status_change_confirm" data-bs-dismiss="modal">Ok</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="delete_confirm_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      ...
      <div class="modal-dialog modal-dialog-centered">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          ...
          <div class="modal-body">
            Are You sure to delete this Stock Request ?

          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
            <button type="button" class="btn btn-primary ims_stock_request_confirm_delete_button"
      ...
      <div class="card-body px-0 pt-0 pb-2">
        ...
        <div class="table-responsive p-0">
          <table class="table align-items-center mb-0  hover" id="ims_stock_request_table" style="width: 100%;">
            <div class="alert alert-success  d-none text-white ims_stock_request_delete_message user_updated_msg"
              role="alert" id="ims_stock_request_delete_message">
              Stock Request Deleted
            ...
            <thead>
              <tr>
                ...
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder">Stock Request From</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder">Stock Request To</th>
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder">Stock Request By</th>
  ...
  $(document).ready(function () {
    ...
    $(function () {
      ...
      $("#ims_stock_request_table").DataTable({
        ...
        ajax: base_url + "ims_stock_request_get_data",
        columns: [{
          data: "DT_RowIndex",
          name: "DT_RowIndex"
        },
        ...
        "drawCallback": function (settings) {
          ...
          $('.open_close_switch').on('change', function () {
            ...
            $('#status_change_confirm').on('click', function () {
              let statusChangePromise = fetch(base_url + 'update_ims_stock_request_status', {
                method: 'post',
                headers: {
    ...
    // update user start
    $(document).on("click", ".ims_stock_request_edit_btn", function (param) {
      let imsStockRequestId = $(this).data("ims_stock_request_id");
      location.replace(base_url + "ims_stock_request_update_form/" + imsStockRequestId);
    });
    // update user end
   ...
   '
      ...
      $('.ims_stock_request_create_button').on('click', function () {
        window.location.replace(base_url + 'ims_stock_request/create')
      })
