        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    <p class="heading " >Stock Request</p>
                    <p class="qr_code">{!! json_decode($ims_stock_request['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $ims_stock_request['ref_num'] }}</p>
                    <p>Stock Request By : {{ $result->stockRequestBy->username }}</p>
                    <p>Created By : {{ $result->createdBy->username }}</p>
                    <p>Stock Request From : {{ $result->stockRequestFrom->warehouse_name }}</p>
                    <p>Stock Request To : {{ $result->stockRequestTo->warehouse_name }}</p>
