    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="ims_damage_stock_from">
                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="alert alert-success  d-none text-white ims_damage_stock_added_message user_updated_msg"
                                                ...
                                                Damage Stock added successfully
...
<script>
    $(document).ready(function () {
        ...
        $("#ims_damage_stock_from").validate({
            rules: {
                ref_num: {
                    required: true,
                    number: true
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response == 'true') {
                            ...
                            $("#ims_damage_stock_from").trigger("reset");
