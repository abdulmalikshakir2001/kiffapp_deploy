        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="" id="ims_damage_stock_form">
                        <input type="hidden" name="ims_damage_stock_id" id="ims_damage_stock_id" value="{{$ims_damage_stock->ims_damage_stock_id}}">
                        @csrf
                            ...
                            <div class="row gy-4 profile_row">
                                ...
                                <div class="col-md-12">
                                    <div class="parent">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h5 class="">Update Stock Request</h5>
                                            </div>

                                            <div class="col-md-8">
                                                <div class="alert alert-success  d-none text-white ims_damage_stock_added_message user_updated_msg"
                                                    role="alert" id="ims_damage_stock_added_message">
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <textarea name="description" id="description" cols="" rows="1" placeholder="Description"
                                                    class="form-control">{{ $ims_damage_stock->description }}</textarea>
                                            </div>
                                    ...
                                    <div class="parent">
                                        <div class="row">
                                            <div class="d-sm-flex justify-content-sm-between">
                                                <h5 class="">Damage StockDetails</h5>
                                ...
                                <div class="col-md-12 product_quotation_request_detail_parent quotation_details">
                                    <div class="parent">
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <input type="hidden" name="detail_id" id="detail_id" class="detail_id" value="{{$detail->ims_damage_stock_detail_id}}">
                                            <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="" id="ims_damage_stock_details_form">
                        @csrf
...
@section('page_script_links')
    <script>
        ...
        $("#stock_request_to").select2({
            ...
            $("#ims_damage_stock_form").validate({
                rules: {
                ref_num: {
                    required: true,
                    number: true
            ...
            messages: {
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        type: "post",
                        url: base_url + "ims_damage_stock_update",
                        ...
                        success: function(response) {
                            if (response == 'true') {
                                ...
                                $(".ims_damage_stock_added_message")
                                    .removeClass("d-none");
                                window.scrollTo(0, 0)
                            }
                        },
