...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path('dashboard_assets/inventory/css/ims_damage_stock_detail_print.css') }}">
        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    <p class="heading " >Damage Stock </p>
                    <p class="qr_code">{!! json_decode($ims_damage_stock['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $ims_damage_stock['ref_num'] }}</p>
            ...
            <div class="detail_table">
                <table>
                    ...
                    $i = 0;
                @endphp
                @foreach ($ims_damage_stock['products'] as $product)
