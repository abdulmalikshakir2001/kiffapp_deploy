                            ...
                            <div class="row gy-4 profile_row">
                                ...
                                <div class="col-md-12">
                                    <div class="parent">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h5 class="">Update Stock Receipt</h5>
                                            </div>
...
@section('page_script_links')
    <script>
        ...
        $("#stock_request_from").select2({
            placeholder: "Stock Receipt From",
            allowClear: true,
            width: "100%",
        });
        // stock request from
        ...
        $("#stock_request_to").select2({
            ...
            messages: {
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        type: "post",
                        url: base_url + "ims_stock_request_update",
                        data: new FormData(form),
                        processData: false,
                        contentType: false,
                        success: function(response) {
                            if (response == 'true') {
                                $("#ims_stock_request_form").trigger("reset");
