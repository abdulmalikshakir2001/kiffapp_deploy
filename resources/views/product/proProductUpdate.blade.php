                        ...
                        <div class="col-md-12">
                            <div class="parent">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="alert alert-success  d-none text-white proProductUpdatedMessage user_updated_msg"
                                            role="alert" id="proProductUpdatedMessage">
                                ...
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="product_sku" id="product_sku" class="form-control"
                                            placeholder="product sku " value="{{ $product->product_sku }}">
                                    </div>
                                    {{-- description --}}
                                    <div class="col-md-6">
                                        <label for="product_description">Description</label>
                                        <textarea name="product_description" id="product_description" cols="" rows="1"
                                            placeholder="Product Description" class="form-control">{{ $product->product_description }}</textarea>
                                    </div>
                                    {{-- sale price --}}
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        @if ($product->product_image)
                                            <img src="{{ asset('app/public/' . 'company_id_' . session()->get('company_id') . '_products' . '/' . $product->product_image) }}"
...
@section('page_script_links')
    <script>
        $(document).ready(function() {
            ...
            //
            // crm lead add  start
            $("#proProductUpdateForm").validate({
                rules: {
                    product_sku: {
                        required: true,
                        remote: {
                            url: base_url + "is_exist_product_sku_for_update",
                            type: "post",
                            data: {
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        type: "post",
                        url: base_url + "proProductUpdate",
                        data: new FormData(form),
                        processData: false,
                        contentType: false,
                        success: function(response) {
                            if (response == 'true') {
                                $("#proProductUpdateForm").trigger("reset");
                                $(".proProductUpdatedMessage").removeClass("d-none");
                                window.scrollTo(0, 0)
                            }
                        },
                    });
