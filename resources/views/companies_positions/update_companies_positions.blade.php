...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container-fluid p-4 create_user_main">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="" method="post" id="companies_positions_updated_form" >
                        @csrf
                        <input type="hidden" name="position_id" id="position_id" value="{{$single_com_pos->position_id}}">
                  ...
                  <div class="alert alert-success  d-none text-white user_updated_msg" role="alert">
                    ...
                    <i class="fa-solid fa-xmark  fa_xmark_user float-end fs-4"></i>
                                ...
                                <div class="mb-3 col-md-6">
                                    <input type="text" class="form-control" placeholder="Position Name" aria-label="Position Name" name="position_name" id="position_name" value="{{$single_com_pos->position_name}}">
                                </div>
                                <!-- user position id -->
                                ...
                                <div class="text-center">
                                    <button type="submit" id="update_com_pos_btn" class="btn bg-gradient-dark w-100 my-4 mb-2">Update Position</button>
                                </div>
                            </div>
                        </div>
                    </form>
