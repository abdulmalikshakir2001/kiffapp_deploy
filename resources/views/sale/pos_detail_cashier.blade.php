        ...
        <form action="" id="user_added_form" >
            ...
            <div class="container-fluid profile">
                <div class="row gy-4 profile_row">
                    ...
                    <div class="modal fade" id="closeRegisterConfirmModal" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Confirm Cose Register</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                Do you want to close register?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal">Close</button>
                                <button type="button" class="btn btn-primary" id="close_register_confirm"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-end align-items-center">
                                        <button type="button"
                    class=" print_button custom_button dark_pink_color me-3"
                    data-id="{{$cashRegister->id}}"><i
                        class="fas fa-print"></i> print</button>
                                        <button type="button"
                                                                        class=" sidenav_zero_index letter-spacing-1 light_blue_col custom_button me-3"
                                                                        id="close_register_button">Close
                                                                        Register</button>
...
// close register start 
$('#close_register_button').on("click", function () {
            $('#closeRegisterConfirmModal').modal('show')
            let closeRegister = "closeRegister"
            $('#close_register_confirm').on('click', function () {



                let closeRegisterPromise = fetch(base_url + "close_register", {
                    method: "post",
                    headers: {
                ...
                closeRegisterPromise.then((response) => {
                    return response.json()
                }).then((json) => {
                    // console.log(json);
                    if (json == 'true') {
                        // alert('register close')
