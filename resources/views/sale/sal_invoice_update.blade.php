        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="sal_invoice_form">
                    <input type="hidden" name="sal_invoice_id" id="sal_invoice_id"
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="alert alert-success  d-none text-white sal_invoice_added_message user_updated_msg"
                                                role="alert" id="sal_invoice_added_message">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="ref_num" id="ref_num" class="form-control"
                                                placeholder="Refrence Number" value="{{ $salInvoice->ref_num }}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control">{{ $salInvoice->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" name="creation_date" id="creation_date"
                                                class="form-control" value="{{ $salInvoice->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input type="date" name="delivery_date" id="delivery_date"
                                                class="form-control" value="{{$salInvoice->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" name="creation_time" id="creation_time"
                                                class="form-control" value="{{ $salInvoice->creation_time }}">
                                        </div>
                                        {{-- taxes --}}
                                        <div class="col-md-6">
    ...
    $(document).ready(function () {
        ...
        $("#sal_invoice_form").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "sal_invoice_update",
                    data: new FormData(form),
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response == 'true') {
                            $(".sal_invoice_added_message")
                                .removeClass("d-none");
                            window.scrollTo(0, 0)
                        }
                    },
