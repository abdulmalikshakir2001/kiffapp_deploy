                                ...
                                <div class="parent">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="sal_quotation_id" id="sal_quotation_id"
                                                class="form-select sal_quotation_id">
                                                <option></option>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response == 'true') {
                            ...
                            defaultSelect2($('#sal_quotation_id'))
