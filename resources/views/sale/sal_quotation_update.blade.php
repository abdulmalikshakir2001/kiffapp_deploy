        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="sal_quotation_form">
                    <input type="hidden" name="sal_quotation_id" id="sal_quotation_id"
                        ...
                        <div class="row gy-4 profile_row">
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="">Update Sale Quotation </h5>
                                        </div>
                                    ...
                                    <div class="d-sm-flex justify-content-sm-between mb-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="total_amount" name="total_amount"
                                                ...
                                                value="{{$salQuotation->total_price}}">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control">{{ $salQuotation->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" name="creation_date" id="creation_date"
                                                class="form-control" value="{{ $salQuotation->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input type="date" name="delivery_date" id="delivery_date"
                                                class="form-control" value="{{$salQuotation->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" name="creation_time" id="creation_time"
                                                class="form-control" value="{{ $salQuotation->creation_time }}">
                                        </div>
                                        {{-- taxes --}}
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="quotation_status" id="quotation_status"
                                                ...
                                                <option></option>
                                                <option value="pending" {{$salQuotation->
                                                    quotation_status=="pending"?"selected":""}}
                                                    >Pending</option>
                                                <option value="approved" {{$salQuotation->
                                                    quotation_status=="approved"?"selected":""}}
                                                    >Approved</option>
                                                <option value="rejected" {{$salQuotation->
    ...
    $(document).ready(function () {
        ...
        $("#sal_quotation_form").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "sal_quotation_update",
