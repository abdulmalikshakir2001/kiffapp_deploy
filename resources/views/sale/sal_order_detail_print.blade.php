        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    <p class="heading ">Sale Order</p>
                    <p class="qr_code">{!! json_decode($salOrder['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $salOrder['ref_num'] }}</p>
                    <p class="">Creation Date : {{$salOrder['created_at']}}</p>
                    <p class="">Order Date : {{$salOrder['order_date']}}</p>
                </div>
            </div>
            ...
            <div class="detail_table">
                ...
                <table>
                    ...
                    $i = 0;
                    @endphp
                    @foreach ($salOrder['products'] as $product)
