        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="sal_delivery_note_form">
                    <input type="hidden" name="sal_delivery_note_id" id="sal_delivery_note_id"
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="alert alert-success  d-none text-white sal_delivery_note_added_message user_updated_msg"
                                                role="alert" id="sal_delivery_note_added_message">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control">{{ $salDeliveryNote->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" name="creation_date" id="creation_date"
                                                class="form-control" value="{{ $salDeliveryNote->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input type="date" name="delivery_date" id="delivery_date"
                                                class="form-control" value="{{$salDeliveryNote->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" name="creation_time" id="creation_time"
                                                class="form-control" value="{{ $salDeliveryNote->creation_time }}">
                                        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#sal_delivery_note_form").validate({
            rules: {
                ref_num: {
                    required: true,
                    number: true
            ...
            submitHandler: function (form) {
                ...
                if ($('.product_ids_array').length == 0) {
                    $('#sal_delivery_note_form').prepend(
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "sal_delivery_note_update",
                    data: new FormData(form),
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response == 'true') {
                            $(".sal_delivery_note_added_message")
                                .removeClass("d-none");
                            window.scrollTo(0, 0)
                        }
                    },
