                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="user_type" id="user_type" class="form-select user_type">
                                        ...
                                        <option value="Customer" {{ $single_user->user_type == 'Customer' ? 'selected' : '' }}> Customer</option>
                                        <option value="CustomerCustomer" {{ $single_user->user_type == 'CustomerCustomer' ? 'selected' : '' }}> CustomerCustomer</option>
                        ...
                        <div class="parent">
                            <div class="row justify-content-end">
                                <div class="col-md-2">
                                    ...
                                    <button type="submit" class="btn btn-primary  w-100" id="added_user_btn">Update Customer</button>
