...
<head>
    ...
    <link rel="stylesheet"
        href="{{ public_path('dashboard_assets/sale/css/sal_delivery_note_detail_print.css') }}">
        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    ...
                    <p class="qr_code">{!! json_decode($salDeliveryNote['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $salDeliveryNote['ref_num'] }}</p>
                    <p class="">Creation Date : {{$salDeliveryNote['creation_date']}}</p>
                    <p class="">Creation Time : {{$salDeliveryNote['delivery_date']}}</p>
                </div>
            </div>
            ...
            <div class="detail_table">
                ...
                <table>
                    ...
                    $i = 0;
                @endphp
                @foreach ($salDeliveryNote['products'] as $product)
