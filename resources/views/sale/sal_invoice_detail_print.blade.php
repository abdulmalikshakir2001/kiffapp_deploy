...
<head>
    ...
    <link rel="stylesheet"
        href="{{ public_path('dashboard_assets/sale/css/sal_invoice_detail_print.css') }}">
        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    <p class="heading ">Sale Invoice</p>
                    <p class="qr_code">{!! json_decode($salInvoice['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $salInvoice['ref_num'] }}</p>
                    <p class="">Creation Date : {{$salInvoice['creation_date']}}</p>
                    <p class="">Creation Time : {{$salInvoice['delivery_date']}}</p>
                </div>
            </div>
            ...
            <div class="detail_table">
                ...
                <table>
                    ...
                    $i = 0;
                    @endphp
                    @foreach ($salInvoice['products'] as $product)
