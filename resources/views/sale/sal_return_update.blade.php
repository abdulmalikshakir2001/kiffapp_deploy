    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="sal_return_form">
                    <input type="hidden" name="sal_return_id" id="sal_return_id"
                        value="{{ $salReturn->sal_return_id }}">
                    @csrf
                        ...
                        <div class="row gy-4 profile_row">
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="">Update Sale Return </h5>
                                        </div>

                                        <div class="col-md-8">
                                            <div class="alert alert-success  d-none text-white sal_return_added_message user_updated_msg"
                                                role="alert" id="sal_return_added_message">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="supplier_id" id="supplier_id" class="form-select supplier_id">
                                                ...
                                                <option value="{{ $supplier->user_id }}" {{$salReturn->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="sal_order_id" id="sal_order_id"
                                                class="form-select sal_order_id">
                                                <option></option>
                                                @foreach ($salOrders as $salOrder)
                                                <option value="{{ $salOrder->sal_order_id }}" {{$salReturn->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="ref_num" id="ref_num" class="form-control"
                                                placeholder="Refrence Number" value="{{ $salReturn->ref_num }}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control">{{ $salReturn->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" name="creation_date" id="creation_date"
                                                class="form-control" value="{{ $salReturn->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input type="date" name="delivery_date" id="delivery_date"
                                                class="form-control" value="{{$salReturn->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" name="creation_time" id="creation_time"
                                                class="form-control" value="{{ $salReturn->creation_time }}">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="status" id="status"
                                                ...
                                                <option></option>
                                                <option value="pending" {{$salReturn->
                                                    status=="pending"?"selected":""}}
                                                    >Pending</option>
                                                <option value="delivered" {{$salReturn->
                                                    status=="delivered"?"selected":""}}
                                                    >Delivered</option>
                                                <option value="cancelled" {{$salReturn->
                                ...
                                <div class="parent">
                                    <div class="row">
                                        <div class="d-sm-flex justify-content-sm-between">
                                            <h5 class="">Sale Return Details</h5>
                            ...
                            $i = 0;
                            @endphp
                            @foreach ($salReturn->details as $detail)
                                ...
                                <div class="parent">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <input type="hidden" name="detail_id" id="detail_id" class="detail_id"
                                            value="{{ $detail->sal_return_detail_id }}">
                                        <div class="col-md-6">
    ...
    $(document).ready(function () {
        ...
        $("#sal_return_form").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "sal_return_update",
                    data: new FormData(form),
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response == 'true') {
                            $(".sal_return_added_message")
                                .removeClass("d-none");
                            window.scrollTo(0, 0)
                        }
                    },
