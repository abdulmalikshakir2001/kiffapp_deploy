...
<head>
    ...
    <link rel="stylesheet"
        href="{{ public_path('dashboard_assets/sale/css/sal_return_detail_print.css') }}">
        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    <p class="heading ">Sale Return</p>
                    <p class="qr_code">{!! json_decode($salReturn['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $salReturn['ref_num'] }}</p>
                    <p class="">Creation Date : {{$salReturn['creation_date']}}</p>
                    <p class="">Creation Time : {{$salReturn['delivery_date']}}</p>
                </div>
            </div>
            ...
            <div class="detail_table">
                ...
                <table>
                    ...
                    $i = 0;
                @endphp
                @foreach ($salReturn['products'] as $product)
