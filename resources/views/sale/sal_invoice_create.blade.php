            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response == 'true') {
                            // current
                            defaultSelect2($('#sal_order_id'))
                            defaultSelect2($('#supplier_id'))
                            defaultSelect2($('#invoice_status'))
