...
<div class="row">
  <div class="col-md-12">
    ...
    <form action="" id="journal_entry_form">
      @csrf
      <input type="hidden" name="acc_transaction_id" id="acc_transaction_id" value="{{$acc_transaction_id}}">
            ...
            <div class="parent">
              ...
              <div class="row gy-3">
                <div class="col-md-4">
                  ...
                  <input type="date" class="form-control" placeholder="Date" aria-label="Date" name="date" id="date" value="{{$transaction->date}}">
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <select name="acc_fiscal_period_id" id="acc_fiscal_period_id"
                    ...
                    <option value="{{$fiscalPeriod->acc_fiscal_period_id}}" 
                        {{$fiscalPeriod->acc_fiscal_period_id == $transaction->fiscal_period_id ?'selected':''}}
                ...
                <div class="col-md-4">
                  ...
                  <select name="acc_cost_center_id" id="acc_cost_center_id" class="form-select acc_cost_center_id">
                    ...
                    <option value="{{$costCenter->acc_cost_center_id}}"
                        {{$costCenter->acc_cost_center_id == $transaction->cost_center_id ?'selected':''}}
                ...
                <div class="col-md-4">
                  ...
                  <select name="acc_control_code_id" id="acc_control_code_id" class="form-select acc_control_code_id">
                    ...
                    <option value="{{$controlCode->acc_control_code_id}}"

                        {{$controlCode->acc_control_code_id == $transaction->control_code_id ?'selected':''}}
                        >{{$controlCode->control_code}}</option>
                    @endforeach
                  </select>
                </div>
                <!-- Currency-->
                <div class="col-md-4">
                  ...
                  <select name="acc_currency_id" id="acc_currency_id" class="form-select acc_currency_id">
                    ...
                    <option value="{{$currency->name}}" {{$currency->name ==$transaction->currency_id ?'selected':"" }}
            ...
            <div class="parent">
              ...
              <div class="row gy-3">
                            ...
                            <div class="col-md-12">
                              <select name="account_id" id="account_id" class="form-select account_id">
                                ...
                                <option value="{{$account->acc_account_id}}"
                                   ...
                                   {{$journalEntry->account_id == $account->acc_account_id ?'selected':"" }}
                                  > 
                                   {{$account->name}}
                                  </option>
                                @endforeach
                          ...
                          <td>
                            ...
                            <div class="col-md-12">
                              ...
                              <input type="text" name="debit" id="debit" class="debit foreign_currency form-control "
                                value="{{($journalEntry->debit / $transaction->exchange_rate)}}">
                            </div>
                          </td>
                          ...
                          <td class="show_when_other_currency d-none">
                            <div class="col-md-12">
                              ...
                              <input type="text" name="exchange_rate" id="exchange_rate"
                                class="exchange_rate  exchange_rate_debit form-control " value="{{$journalEntry->debit}}" disabled>
                            </div>
                          </td>
                          <td>
                            <div class="col-md-12">
                              <input type="text" name="credit" id="credit" class="credit foreign_currency form-control"
                                value="{{($journalEntry->credit / $transaction->exchange_rate)}}">
                            </div>
                          </td>
                          ...
                          <td class="show_when_other_currency d-none">
                            <div class="col-md-12">
                              ...
                              <input type="text" name="exchange_rate_credit" id="exchange_rate_credit"
                                class="exchange_rate exchange_rate_credit form-control " value="{{$journalEntry->credit}}" disabled>
                            </div>
                          </td>
                ...
                <div class="col-md-12">
                  ...
                  <span class="badge bg-dark add_dr_cr_row d-none">Add Row</span>
                  <!-- buttons -->
                </div>
                    ...
                    <div class="col-md-6">
                      <div class="col-md-12">
                        ...
                        <input type="text" name="currency_exchange_rate" id="currency_exchange_rate"
                          class="form-control" value="{{$transaction->exchange_rate}}" disabled>
                      </div>
                      <div class="col-md-12">
                        <label for="total_debit">Total Debit</label>
                        <input type="text" name="total_debit" id="total_debit" class="form-control" value="{{$totalDebit}}"
                          disabled>
                      </div>
                      <div class="col-md-12">
                        <label for="total_credit">Total Credit</label>
                        <input type="text" name="total_credit" id="total_credit" class="form-control" value="{{$totalDebit}}"
                          disabled>
                      </div>
  ...
  $('th.show_when_other_currency').removeClass('d-none')
    ...
    $("#journal_entry_form").validate({
      ...
      submitHandler: function (form) {
        ...
        $.ajax({
          type: "post",
          url: base_url + "post_transaction_store",
      ...
      let newRow = `<tr class="">
                                     <td class="d-none">  
                                        <div class="form-check d-none">
                                          <input class="form-check-input checkbox d-none" type="checkbox" value="" id="flexCheckDefault">
                                        </div>
                                      </td>
