          ...
          <div class="col-md-12">
            <div class="parent">
              ...
              <div class="row gy-3">
                ...
                <div class="col-md-4">
                  <label for="acc_payable_name">Account Payable</label>
                  <input type="text" class="form-control" name="acc_payable_name" id="acc_payable_name" placeholder="Enter account payable name">
                ...
                <div class="col-md-4 acc_payable_div d-none">
                  <label for="acc_amount">Account Balance</label>
...
fetch(base_url+'acc_payable_fetch', {
  method: 'POST',
  headers: {
  ...
  .then(data => {
    ...
    if(data.length == 1){
      ...
      $('#account_id').closest('td').next().find('.debit').val(balance)
      $('#account_id').closest('td').next().next().next().find('.credit').prop('disabled',true)
