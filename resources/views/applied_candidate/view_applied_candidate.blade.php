...
<div class="row">
  <div class="col-md-12 ">
    ...
    <div class="modal fade" id="shotlist" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header vacancy_modal_header">
            <h1 class="modal-title fs-5 text-white" id="exampleModalLabel">Interview</h1>
          ...
          <div class="modal-body p-0">
            ...
            <div class="container-fluid create_user_main p-0">
              <div class="row">
                <div class="col-md-12">
                  <form role="form" action="" method="post" id="interview_form">
                    @csrf
                    ...
                    <div class="container-fluid">
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                          <label for="publish_date">Interview Date</label>
                          <input type="datetime-local" name="interview_date" id="interview_date" placeholder="Inter view" class="form-control">
                        </div>
                        <!-- vacancy_status -->
                        <!-- <div class="mb-3 col-md-12">
                        ...
                        <div class="text-center col-md-4 m-auto">
                          <button type="submit" id="interview_btn" class="btn bg-primary w-100 my-4 mb-2 text-white" data-bs-dismiss="modal">Interview</button>
                        </div>
                      </div>
                    </div>
                  </form>
    ...
    <div class="card mb-4 view_user_card">
      <div class="card-body px-0 pt-0 pb-2">
        <div class="table-responsive p-0">
          <table class="table align-items-center mb-0  hover" id="view_applied_candidate" style="width: 100%;">
                                  <!-- show message when user interviewd    start  -->
                                  <div class="mb-3 col-md-12">
              <div class="alert alert-success  d-none text-white user_interview_msg user_updated_msg" role="alert">
                Inter view date Send To User
                <i class="fa-solid fa-xmark  fa_xmark_user float-end fs-4"></i>
              </div>
            </div>
            <!-- show message when user interviewd    start  -->
            <!-- show message when user already interviewd    start  -->
            <div class="mb-3 col-md-12">
              <div class="alert alert-warning  d-none text-white interviewd_user user_updated_msg" role="alert">
                User already interviewd For this job
                <i class="fa-solid fa-xmark  fa_xmark_user float-end fs-4"></i>
              </div>
            </div>
            <!-- show message when user already interviewd    start  -->
