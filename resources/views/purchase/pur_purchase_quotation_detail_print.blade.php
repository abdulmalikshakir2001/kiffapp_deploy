        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    <p class="heading ">Purchase Quotation</p>
                    <p class="qr_code">{!! json_decode($purPurchaseQuotation['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $purPurchaseQuotation['ref_num'] }}</p>
                    <p class="">Creation Date : {{$purPurchaseQuotation['creation_date']}}</p>
                    <p class="">Creation Time : {{$purPurchaseQuotation['delivery_date']}}</p>
                </div>
            </div>
            ...
            <div class="detail_table">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>Total : </td>
                        <td></td>
                        <td>{{$purPurchaseQuotation['total_price']}}</td>
                    </tr>
