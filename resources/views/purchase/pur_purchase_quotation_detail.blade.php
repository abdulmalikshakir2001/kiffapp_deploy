        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="pur_purchase_quotation_form">
                    <input disabled type="hidden" name="pur_purchase_quotation_id" id="pur_purchase_quotation_id"
                                    ...
                                    <div class="row position-relative">
                                        ...
                                        <div class="col-md-8 col-8 d-flex justify-content-end">
                                            <button type="button"
                                                ...
                                                data-id="{{ $purPurchaseQuotation->pur_quotation_id }}"><i
                                ...
                                <div class="parent">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select disabled name="pro_quotation_req_id" id="pro_quotation_req_id"
                                                ...
                                                <option value="{{ $proQuotationRequest->pro_quotation_req_id }}" {{
                                                    $purPurchaseQuotation->pro_quotation_req_id ==
                                                    $proQuotationRequest->pro_quotation_req_id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea disabled name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control input_disabled">{{ $purPurchaseQuotation->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="date" name="creation_date" id="creation_date"
                                                ...
                                                value="{{ $purPurchaseQuotation->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="date" name="delivery_date" id="delivery_date"
                                                class="form-control input_disabled"
                                                value="{{ $purPurchaseQuotation->delivery_date }}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="time" name="creation_time" id="creation_time"
                                                class="form-control input_disabled"
                                                value="{{ $purPurchaseQuotation->creation_time }}">
                                        </div>
                                        {{-- taxes --}}
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select disabled name="quotation_status" id="quotation_status"
                                                ...
                                                <option></option>
                                                <option value="pending" {{ $purPurchaseQuotation->quotation_status ==
                                                    'pending' ? 'selected' : '' }}>
                                                    Pending</option>
                                                <option value="approved" {{ $purPurchaseQuotation->quotation_status ==
                                                    'approved' ? 'selected' : '' }}>
                                                    Approved</option>
                                                <option value="rejected" {{ $purPurchaseQuotation->quotation_status ==
                                                    'rejected' ? 'selected' : '' }}>
                                                    Rejected</option>
                                            </select>
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.print_button', function () {
            ...
            $.ajax({
                type: "post",
                url: base_url + "pur_purchase_quotation_url",
                data: {
                    id: id
                },
                dataType: "json",
