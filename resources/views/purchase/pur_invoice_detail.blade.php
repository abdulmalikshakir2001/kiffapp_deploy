...
<div class="row profile">
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="" id="pur_invoice_form">
                    <input disabled type="hidden" name="pur_invoice_id" id="pur_invoice_id"
                        value="{{ $purInvoice->pur_invoice_id }}">
                    @csrf
                    ...
                    <div class="container-fluid ">
                        <div class="row gy-4 profile_row">
                                                                ...
                                                                <div class="row position-relative">
                                                                    ...
                                                                    <div class="col-md-8 col-8 d-flex justify-content-end">
                                                                        <button type="button"
                                                                            ...
                                                                            data-id="{{ $purInvoice->pur_invoice_id }}"><i
                                ...
                                <div class="parent">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select disabled name="supplier_id" id="supplier_id" class="form-select input_disabled supplier_id">
                                                <option></option>
                                                @foreach ($suppliers as $supplier)
                                                <option value="{{ $supplier->user_id }}" {{$purInvoice->
                                        ...
                                        {{-- pqr --}}
                                        <div class="col-md-4">
                                            <label for="pur_order_id"> select PQR </label>
                                            <select disabled name="pur_order_id" id="pur_order_id"
                                                class="form-select input_disabled pur_order_id">
                                                <option></option>
                                                @foreach ($purPurchaseOrders as $purPurchaseOrder)
                                                <option value="{{ $purPurchaseOrder->pur_order_id }}" {{$purInvoice->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="text" name="ref_num" id="ref_num" class="form-control input_disabled"
                                                placeholder="Refrence Number" value="{{ $purInvoice->ref_num }}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea disabled name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control input_disabled">{{ $purInvoice->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="date" name="creation_date" id="creation_date"
                                                class="form-control input_disabled" value="{{ $purInvoice->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input disabled type="date" name="delivery_date" id="delivery_date"
                                                class="form-control input_disabled" value="{{$purInvoice->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="time" name="creation_time" id="creation_time"
                                                class="form-control input_disabled" value="{{ $purInvoice->creation_time }}">
                                        </div>
                                        {{-- taxes --}}
                                        <div class="col-md-6">
                                            ...
                                            <select disabled name="taxes" id="taxes" class="form-select input_disabled taxes"
                                                multiple="multiple">

                                                <option></option>
                                                @php
                                                $taxesArray = explode(',', $purInvoice->taxes);
                                                @endphp
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select disabled name="invoice_status" id="invoice_status"
                                                ...
                                                <option></option>
                                                <option value="pending" {{$purInvoice->
                                                    invoice_status=="pending"?"selected":""}}
                                                    >Pending</option>
                                                <option value="approved" {{$purInvoice->
                                                    invoice_status=="approved"?"selected":""}}
                                                    >Approved</option>
                                                <option value="rejected" {{$purInvoice->
                            ...
                            $i = 0;
                            @endphp
                            @foreach ($purInvoice->details as $detail)
                                ...
                                <div class="parent">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <input disabled type="hidden" name="detail_id" id="detail_id" class="detail_id"
                                            value="{{ $detail->pur_invoice_detail_id }}">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="text" name="unit_price_{{ $i }}" id="unit_price_{{ $i }}"
                                                class="form-control input_disabled unit_price price_qty_keyup" placeholder="Unit Price"
