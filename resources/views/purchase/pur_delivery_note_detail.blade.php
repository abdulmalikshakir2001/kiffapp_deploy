        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="pur_delivery_note_form">
                    <input disabled type="hidden" name="pur_delivery_note_id" id="pur_delivery_note_id"
        ...
        <div class="row position-relative">
            ...
            <div class="col-md-8 col-8 d-flex justify-content-end">
                <button type="button"
                    ...
                    data-id="{{ $purDeliveryNote->pur_delivery_note_id }}"><i
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea disabled name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control input_disabled ">{{ $purDeliveryNote->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="date" name="creation_date" id="creation_date"
                                                class="form-control input_disabled " value="{{ $purDeliveryNote->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input disabled type="date" name="delivery_date" id="delivery_date"
                                                class="form-control input_disabled " value="{{$purDeliveryNote->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input disabled type="time" name="creation_time" id="creation_time"
                                                class="form-control input_disabled " value="{{ $purDeliveryNote->creation_time }}">
                                        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.print_button', function () {
            ...
            $.ajax({
                type: "post",
                url: base_url + "pur_delivery_note_url",
                data: {
                    id: id
                },
                dataType: "json",
