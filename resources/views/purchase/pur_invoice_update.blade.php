        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="pur_invoice_form">
                    <input type="hidden" name="pur_invoice_id" id="pur_invoice_id"
                        ...
                        <div class="row gy-4 profile_row">
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="">Update Invoice </h5>
                                        </div>

                                        <div class="col-md-8">
                                            <div class="alert alert-success  d-none text-white pur_invoice_added_message user_updated_msg"
                                                role="alert" id="pur_invoice_added_message">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control">{{ $purInvoice->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" name="creation_date" id="creation_date"
                                                class="form-control" value="{{ $purInvoice->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input type="date" name="delivery_date" id="delivery_date"
                                                class="form-control" value="{{$purInvoice->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" name="creation_time" id="creation_time"
                                                class="form-control" value="{{ $purInvoice->creation_time }}">
                                        </div>
                                        {{-- taxes --}}
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="invoice_status" id="invoice_status"
                                                class="form-select invoice_status">
                                                <option></option>
...
<script>
    ...
    $(document).ready(function () {
        ...
        // status
        $('#invoice_status').on('change', function (param) {
            let invoice_statusValue = $(this).val();
            if (invoice_statusValue == "") {
                $('#invoice_status-error').removeClass('d-none') // label
            } else {
                $('#invoice_status-error').addClass('d-none') // label
            }
        })
        ...
        $("#pur_invoice_form").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "pur_invoice_update",
                    data: new FormData(form),
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response == 'true') {
                            $(".pur_invoice_added_message")
                                .removeClass("d-none");
                            window.scrollTo(0, 0)
                        }
                    },
