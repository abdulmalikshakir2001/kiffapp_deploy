...
<head>
    ...
    <link rel="stylesheet"
        href="{{ public_path('dashboard_assets/purchase/css/pur_invoice_detail_print.css') }}">
        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    <p class="heading ">Purchase Invoice</p>
                    <p class="qr_code">{!! json_decode($purInvoice['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $purInvoice['ref_num'] }}</p>
                    <p class="">Creation Date : {{$purInvoice['creation_date']}}</p>
                    <p class="">Creation Time : {{$purInvoice['delivery_date']}}</p>
                </div>
            </div>
            ...
            <div class="detail_table">
                ...
                <table>
                    ...
                    $i = 0;
                    @endphp
                    @foreach ($purInvoice['products'] as $product)
