                ...
                <form action="" id="pur_purchase_order_form">
                    ...
                    <div class="container-fluid ">
                        <div class="row gy-4 profile_row">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="supplier_id" id="supplier_id" class="form-select supplier_id">
                                                ...
                                                <option value="{{ $supplier->user_id }}">{{ $supplier->username }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="pur_quotation_id" id="pur_quotation_id"
                                                class="form-select pur_quotation_id">
                                                <option></option>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" name="order_time" id="order_time" class="form-control">
                                        </div>
                                        {{-- taxes --}}
                                        <div class="col-md-8">
                            ...
                            <div class="col-md-12 product_quotation_request_detail_parent quotation_details mt-0">
                                <div class="parent">
    ...
    $(document).ready(function () {
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="discount_${i}" id="discount_${i}"
                                                    class="form-control discount" placeholder="Discount"></div>
                                                    {{-- taxes in % --}}
                                                    <div class="col-md-4">
                                                <label for="taxes_in_perc">Taxes in %</label>
                                                <textarea name="taxes_in_perc" id="taxes_in_perc" cols="" rows="1" class="form-control taxes_in_perc" placeholder="Taxes %"></textarea>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="sub_total">Sub Total</label>
                                                <input type="sub_total" name="sub_total" id="sub_total" class="form-control sub_total" placeholder="Sub Total">
                                            </div>
        ...
        $("#pur_purchase_order_form").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "pur_purchase_order",
                    data: new FormData(form),
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response == 'true') {
                            defaultSelect2($('#pro_quotation_req_id'))
                            defaultSelect2($('#pur_quotation_id'))
