            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="" id="pur_purchase_order_form">
                        <input disabled type="hidden" name="pur_purchase_order_id" id="pur_purchase_order_id"
        ...
        <div class="row position-relative">
            ...
            <div class="col-md-8 col-8 d-flex justify-content-end">
                <button type="button"
                    ...
                    data-id="{{ $purPurchaseOrder->pur_order_id }}"><i
                                    ...
                                    <div class="parent">
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select disabled name="pur_quotation_id" id="pur_quotation_id" class="form-select pur_quotation_id"
                                                    >
                                                    <option></option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <textarea disabled name="description" id="description" cols="" rows="1" placeholder="Description"
                                                    class="form-control input_disabled">{{ $purPurchaseOrder->description }}</textarea>
                                            </div>
                                            {{-- order date  --}}
                                            <div class="col-md-4">
                                                <label for="order_date">Order Date</label>
                                                <input disabled type="date" name="order_date" id="order_date"
                                                    class="form-control input_disabled" value="{{ $purPurchaseOrder->order_date }}">
                                            </div>
        ...
        $(document).ready(function() {
          ...
          $('#status').on('change', function(param) {
            ...
            $(document).on('click', '.print_button', function() {
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "pur_purchase_order_url",
                    data: {
                        id: id
                    },
                    dataType: "json",
