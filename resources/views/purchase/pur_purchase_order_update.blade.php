        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="" id="pur_purchase_order_form">
                        <input type="hidden" name="pur_purchase_order_id" id="pur_purchase_order_id"
                            value="{{ $purPurchaseOrder->pur_order_id }}">
                        @csrf
                        ...
                        <div class="container-fluid ">
                            <div class="row gy-4 profile_row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="alert alert-success  d-none text-white pur_purchase_order_added_message user_updated_msg"
                                                    role="alert" id="pur_purchase_order_added_message">
                                ...
                                <div class="col-md-12">
                                    <div class="parent">
                                        ...
                                        <div class="row gy-3">
                                                ...
                                                <select name="supplier_id" id="supplier_id" class="form-select supplier_id">
                                                    ...
                                                    @foreach ($suppliers as $supplier)
                                                        <option value="{{ $supplier->user_id }}"
                                                            {{ $purPurchaseOrder->supplier_id == $supplier->user_id ? 'selected' : '' }}>
                                                            {{ $supplier->username }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            {{-- pq --}}
                                            <div class="col-md-4">
                                                <label for="pur_quotation_id"> select Purchase quotation </label>
                                                <select name="pur_quotation_id" id="pur_quotation_id" class="form-select pur_quotation_id"
                                                    >
                                                    <option></option>
                                                    @foreach ($purPurchaseQuotations as $purPurchaseQuotation)
                                                        <option value="{{ $purPurchaseQuotation->pur_quotation_id }}"

                                                            {{$purPurchaseOrder->pur_quotation_id==$purPurchaseQuotation->pur_quotation_id?"selected":""}}
                                                            >{{ $purPurchaseQuotation->ref_num }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="ref_num" id="ref_num" class="form-control"
                                                    placeholder="Refrence Number" value="{{ $purPurchaseOrder->ref_num }}">
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <textarea name="description" id="description" cols="" rows="1" placeholder="Description"
                                                    class="form-control">{{ $purPurchaseOrder->description }}</textarea>
                                            </div>
                                            {{-- order date  --}}
                                            <div class="col-md-4">
                                                <label for="order_date">Order Date</label>
                                                <input type="date" name="order_date" id="order_date"
                                                    class="form-control" value="{{ $purPurchaseOrder->order_date }}">
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="time" name="order_time" id="order_time"
                                                    class="form-control"
                                                    value="{{ $purPurchaseOrder->order_time }}"
                                                    >
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="taxes" id="taxes" class="form-select taxes"
                                                    ...
                                                    <option></option>
                                                    @php
                                                        $taxesArray = explode(',', $purPurchaseOrder->taxes);
                                                    @endphp
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="status" id="status" class="form-select status">
                                                    <option></option>
                                                    <option value="open" {{$purPurchaseOrder->status=="open"?"selected":""}}>Opened</option>
                                                    <option value="shipped" 
                                                    {{$purPurchaseOrder->status=="shipped"?"selected":""}}
                                                    >Shipped</option>
                                                    <option value="cancelled"
                                                    {{$purPurchaseOrder->status=="cancelled"?"selected":""}}
                                                    >Cancelled</option>
                                                </select>
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="parent">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" id="total_amount" name="total_amount" class="total_amount valid" placeholder="Total Amount" value="{{$purPurchaseOrder->total_price}}">
                                ...
                                @php
                                    $i = 0;
                                @endphp
                                @foreach ($purPurchaseOrder->details as $detail)
                                        ...
                                        <div class="parent">
                                            ...
                                            <div class="row gy-3">
                                                ...
                                                <input type="hidden" name="detail_id" id="detail_id" class="detail_id"
                                                    value="{{ $detail->pur_order_detail_id }}">
                                                <div class="col-md-4">
    ...
    // Utility functions end -------------------------------------------------------------
        $(document).ready(function() {
          ...
          $('#status').on('change', function(param) {
            ...
            // purchase Quotation
            $('#pur_quotation_id').on('change', function(param) {
                let pur_quotation_idValue = $(this).val();
                if (pur_quotation_idValue == "") {
                    $('#pur_quotation_id-error').removeClass('d-none') // label
                } else {
                    $('#pur_quotation_id-error').addClass('d-none') // label
                }
            })
            $("#pur_quotation_id").select2({
        ...
        // taxes and pro taxes changeddd end 
            ...
            $("#pur_purchase_order_form").validate({
                rules: {
                        ref_num: {
                            required: true,
                            number: true
...
if ($('.sub_total_array').length == 0) {
    $('#pur_purchase_order_form').prepend(
...
// sub total end
                    ...
                    $.ajax({
                        type: "post",
                        url: base_url + "pur_purchase_order_update",
                        data: new FormData(form),
                        processData: false,
                        contentType: false,
                        success: function(response) {
                            if (response == 'true') {
                                // $("#pur_purchase_order_form").trigger("reset");
                                $(".pur_purchase_order_added_message")
                                    .removeClass("d-none");
                                window.scrollTo(0, 0)
                            }
                        },
