...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path('dashboard_assets/purchase/css/pur_pro_quotation_req.css') }}">
    <link rel="stylesheet"
        href="{{ public_path('dashboard_assets/purchase/css/pur_pro_quotation_req_detail_print.css') }}">
        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    ...
                    <p class="qr_code">{!! json_decode($purPurchaseOrder['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $purPurchaseOrder['ref_num'] }}</p>
                    <p class="">Creation Date : {{$purPurchaseOrder['created_at']}}</p>
                    <p class="">Order Date : {{$purPurchaseOrder['order_date']}}</p>
                </div>
            </div>
            ...
            <div class="detail_table">
                ...
                <table>
                    ...
                    $i = 0;
                    @endphp
                    @foreach ($purPurchaseOrder['products'] as $product)
                    ...
                    <tr>
                        ...
                        <td>Total : </td>
                        <td></td>
                        <td>{{$purPurchaseOrder['total_price']}}</td>
                    </tr>
