    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="pur_delivery_note_form">
                    <input type="hidden" name="pur_delivery_note_id" id="pur_delivery_note_id"
                        value="{{ $purDeliveryNote->pur_delivery_note_id }}">
                    @csrf
                        ...
                        <div class="row gy-4 profile_row">
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="">Update Delivery Note </h5>
                                        </div>

                                        <div class="col-md-8">
                                            <div class="alert alert-success  d-none text-white pur_delivery_note_added_message user_updated_msg"
                                                role="alert" id="pur_delivery_note_added_message">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="supplier_id" id="supplier_id" class="form-select supplier_id">
                                                ...
                                                <option value="{{ $supplier->user_id }}" {{$purDeliveryNote->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="pur_order_id" id="pur_order_id"
                                                ...
                                                <option value="{{ $purPurchaseOrder->pur_order_id }}" {{$purDeliveryNote->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="ref_num" id="ref_num" class="form-control"
                                                placeholder="Refrence Number" value="{{ $purDeliveryNote->ref_num }}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control">{{ $purDeliveryNote->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" name="creation_date" id="creation_date"
                                                class="form-control" value="{{ $purDeliveryNote->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input type="date" name="delivery_date" id="delivery_date"
                                                class="form-control" value="{{$purDeliveryNote->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" name="creation_time" id="creation_time"
                                                class="form-control" value="{{ $purDeliveryNote->creation_time }}">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="status" id="status"
                                                ...
                                                <option></option>
                                                <option value="pending" {{$purDeliveryNote->
                                                    status=="pending"?"selected":""}}
                                                    >Pending</option>
                                                <option value="delivered" {{$purDeliveryNote->
                                                    status=="delivered"?"selected":""}}
                                                    >Delivered</option>
                                                <option value="cancelled" {{$purDeliveryNote->
                            ...
                            $i = 0;
                            @endphp
                            @foreach ($purDeliveryNote->details as $detail)
                                ...
                                <div class="parent">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <input type="hidden" name="detail_id" id="detail_id" class="detail_id"
                                            value="{{ $detail->pur_delivery_note_detail_id }}">
                                        <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#pur_delivery_note_form").validate({
            rules: {
                ref_num: {
                    required: true,
                    number: true
            ...
            submitHandler: function (form) {
                ...
                if ($('.product_ids_array').length == 0) {
                    $('#pur_delivery_note_form').prepend(
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "pur_delivery_note_update",
                    data: new FormData(form),
                    processData: false,
                    contentType: false,
                    success: function (response) {
                        if (response == 'true') {
                            $(".pur_delivery_note_added_message")
                                .removeClass("d-none");
                            window.scrollTo(0, 0)
                        }
                    },
