...
<head>
    ...
    <link rel="stylesheet"
        href="{{ public_path('dashboard_assets/purchase/css/pur_delivery_note_detail_print.css') }}">
        ...
        <div class="wrapper">
            ...
            <div class="company_info_parent">
                ...
                <div class="company_info_right">
                    <p class="heading ">Delivery Note</p>
                    <p class="qr_code">{!! json_decode($purDeliveryNote['qr_code_string']) !!}</p>
                    <p>Ref Number : {{ $purDeliveryNote['ref_num'] }}</p>
                    <p class="">Creation Date : {{$purDeliveryNote['creation_date']}}</p>
                    <p class="">Creation Time : {{$purDeliveryNote['delivery_date']}}</p>
                </div>
            </div>
            ...
            <div class="detail_table">
                ...
                <table>
                    ...
                    $i = 0;
                @endphp
                @foreach ($purDeliveryNote['products'] as $product)
