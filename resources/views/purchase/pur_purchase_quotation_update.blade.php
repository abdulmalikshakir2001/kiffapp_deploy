        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" id="pur_purchase_quotation_form">
                    <input type="hidden" name="pur_purchase_quotation_id" id="pur_purchase_quotation_id"
                        value="{{ $purPurchaseQuotation->pur_quotation_id }}">
                    @csrf
                        ...
                        <div class="row gy-4 profile_row">
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="">Update Purchase Quotation </h5>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="d-sm-flex justify-content-sm-between mb-4">
                                        <h5 class="">Purchase Quotation </h5>
                                        <div>
                                            <label for="">Total Amount</label>

                                            <input type="text" id="total_amount" name="total_amount"
                                                class="total_amount" placeholder="Total Amount"
                                                value="{{$purPurchaseQuotation->total_price}}">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="supplier_id" id="supplier_id" class="form-select supplier_id">
                                                ...
                                                <option value="{{ $supplier->user_id }}" {{$purPurchaseQuotation->
                                        ...
                                        {{-- pqr --}}
                                        <div class="col-md-4">
                                            <label for="pro_quotation_req_id"> select PQR </label>
                                            <select name="pro_quotation_req_id" id="pro_quotation_req_id"
                                                class="form-select pro_quotation_req_id">
                                                <option></option>
                                                @foreach ($proQuotationRequests as $proQuotationRequest)
                                                <option value="{{ $proQuotationRequest->pro_quotation_req_id }}"
                                                    {{$purPurchaseQuotation->
                                                    pro_quotation_req_id==$proQuotationRequest->pro_quotation_req_id
                                                    ?"selected":""}}
                                                    >
                                                    {{ $proQuotationRequest->ref_num }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="ref_num" id="ref_num" class="form-control"
                                                ...
                                                value="{{ $purPurchaseQuotation->ref_num }}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="description" id="description" cols="" rows="1"
                                                ...
                                                class="form-control">{{ $purPurchaseQuotation->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="date" name="creation_date" id="creation_date"
                                                class="form-control" value="{{ $purPurchaseQuotation->creation_date }}">
                                        </div>
                                        {{-- delivery date --}}
                                        <div class="col-md-4">
                                            <label for="delivery_date">Delivery Date</label>
                                            <input type="date" name="delivery_date" id="delivery_date"
                                                class="form-control" value="{{$purPurchaseQuotation->delivery_date}}">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="time" name="creation_time" id="creation_time"
                                                class="form-control" value="{{ $purPurchaseQuotation->creation_time }}">
                                        </div>
                                        {{-- taxes --}}
                                        <div class="col-md-6">
                                            ...
                                            <select name="taxes" id="taxes" class="form-select taxes"
                                                ...
                                                <option></option>
                                                @php
                                                $taxesArray = explode(',', $purPurchaseQuotation->taxes);
                                                @endphp
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="quotation_status" id="quotation_status"
                                                ...
                                                <option></option>
                                                <option value="pending" {{$purPurchaseQuotation->
                                                    quotation_status=="pending"?"selected":""}}
                                                    >Pending</option>
                                                <option value="approved" {{$purPurchaseQuotation->
                                                    quotation_status=="approved"?"selected":""}}
                                                    >Approved</option>
                                                <option value="rejected" {{$purPurchaseQuotation->
                                                    quotation_status=="rejected"?"selected":""}}
                                                    >Rejected</option>
                                            </select>
                                        </div>
                                        {{-- <div class="col-md-2">
                                ...
                                <div class="parent">
                                    <div class="row">
                                        <div class="d-sm-flex justify-content-sm-between">
                                            <h5 class="">Purchase Quotation Details</h5>
                            ...
                            $i = 0;
                            @endphp
                            @foreach ($purPurchaseQuotation->details as $detail)
                                ...
                                <div class="parent">
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <input type="hidden" name="detail_id" id="detail_id" class="detail_id"
                                            value="{{ $detail->pur_quotation_detail_id }}">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select name="pro_taxes_{{ $i }}" id="pro_taxes_{{ $i }}"
    ...
    $(document).ready(function () {
        ...
        $("#pur_purchase_quotation_form").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "pur_purchase_quotation_update",
