...
<link rel="stylesheet" href="{{ asset('dashboard_assets/purchase/css/pur_purchase_quotation.css') }}">
@endSection
                        ...
                        <div class="row gy-4 profile_row">
                            ...
                            <div class="col-md-12">
                                <div class="parent">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h5 class="">Add Purchase Quotation </h5>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="alert alert-success  d-none text-white pur_purchase_quotation_added_message user_updated_msg"
                                                ...
                                                Purchase Quotation added successfully
    ...
    if ($(this).val() != "") {
        ...
        $("#pur_purchase_quotation_form").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "post",
                    url: base_url + "pur_purchase_quotation",
