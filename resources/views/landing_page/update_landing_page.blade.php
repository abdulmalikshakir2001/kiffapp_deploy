...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="container-fluid p-4 create_user_main">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="" method="post" id="update_landing_page_form">
                        <input type="hidden" name="id" id="id" value="{{$single_landing_page->id}}">
                        @csrf
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label>Header</label>
                                    <textarea name="header" id="header" cols="" rows="1" placeholder="Header" class="form-control">{{$single_landing_page->header}}</textarea>
                                </div>
                                <!-- main content-->
                                <div class="mb-3 col-md-6">
                                    <label>Mian content of landing page</label>
                                    <textarea name="main_content" id="main_content" cols="" rows="1" placeholder="Main content" class="form-control">{{$single_landing_page->main_content}}</textarea>
                                </div>
                                <!-- footer-->
                                <div class="mb-3 col-md-6">
                                    <label>Footer of landing page</label>
                                    <textarea name="footer" id="footer" cols="" rows="1" placeholder="footer" class="form-control">{{$single_landing_page->footer}}</textarea>
                                </div>
                                <!-- url -->
                                <div class="mb-3 col-md-6">
                                    <label>Unique name for landing page</label>
                                    <input type="text" class="form-control" placeholder="Unique url" aria-label="Middle name" name="unique_url_code" id="unique_url_code" value="{{$single_landing_page->unique_url_code}}">
                                </div>
                                <!-- product template -->
                                <div class="mb-3 col-md-6">
                                    <label>Unique name for landing page</label>
                                    <input type="text" class="form-control" placeholder="Product template" aria-label="Middle name" name="product_template" id="product_template" value="{{$single_landing_page->product_template}}">
                                </div>
                                <div class="text-center">
                                    <button type="submit" id="updated_landing_page_btn" class="btn bg-gradient-dark w-100 my-4 mb-2">Update Landing Page</button>
                                </div>
                            </div>
                        </div>
                    </form>
